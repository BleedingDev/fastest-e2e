...
from chrome_fixture import chrome_fixture
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="fe2e-managed-") as temp:
        ...
        try:
            with chrome_fixture(chrome, profile) as (port, browser_path):
...
"""
                    ...
                    with patch.object(agent, "choose", choose_save), patch.object(Browser, "act", interrupted_act):
